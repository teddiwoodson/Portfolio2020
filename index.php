    	...
    	<div class="container" id="about">
    		<div class="card mt-5 mb-5 border-0" style="max-width: 100%;">
    	  	<div class="row teddi d-flex justify-content-center align-items-center">
                ...
                <a href="<?php echo get_template_directory_uri(); ?>/img/woodson_resume.pdf" target="_blank" type="button" class="btn btn-primary btn-lg">My Resume</a>
...
<section id="experience">
  <div class="row divider align-items-center" id="experience-body">
      ...
      <div class="container">
        <div class="accordion justify-content-center" id="accordionExample">
          ...
          <div class="card-header" id="headingTwo">
            <h6 class="mb-0"><button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                Capstone Student
              </button>
            </h6>
    ...
    <div class="divider-img col-md-5" id="experience-order">
      <img src="<?php echo get_template_directory_uri(); ?>/img/experience.png" class="card-img" alt="...">
    </div>
  </div>
</section>
...
<section>
  <div class="row divider align-items-center">
    <div class="divider-img col-md-5">
      <img src="<?php echo get_template_directory_uri(); ?>/img/education.png" class="card-img" alt="...">
    </div>
    <div class="col-md-7">
      <div class="container">
        <div class="card">
